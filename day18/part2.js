...
const findFirstBlock = (size, bytesPos) => {
  for (let i = 1024; i < bytesPos.length; i++) {
    const total = shortestPath(size, bytesPos.slice(0, i + 1));
...
console.log("findFirstBlock", findFirstBlock(71, bytes));
